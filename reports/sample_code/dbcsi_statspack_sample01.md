...
**요약:**
- **총 스냅샷 수**: 22개
- **평균 메모리 사용량**: 11.60 GB (SGA: 11.10 GB, PGA: 0.50 GB)
- **최소 메모리 사용량**: 11.60 GB
- **최대 메모리 사용량**: 11.60 GB
...
**분석 기간**: 26/01/13 05:43 ~ 26/01/14 02:00

**요약:**
- **총 스냅샷 수**: 22개
- **평균 CPU/s**: 0.01 (최소: 0.01, 최대: 0.01)
- **평균 Read IOPS**: 4.40 (최소: 4.30, 최대: 4.60)
- **평균 Write IOPS**: 1.40 (최소: 1.20, 최대: 3.40)
- **평균 Commits/s**: 0.04 (최소: 0.00, 최대: 0.90)

**상세 데이터 (최근 22개 - 하루 패턴):**

| 시간 | Duration (m) | CPU/s | Read IOPS | Write IOPS | Commits/s |
|------|--------------|-------|-----------|------------|-----------|
| 26/01/13 05:43 | 8.5 | 0.01 | 4.60 | 1.20 | 0.00 |
| 26/01/13 06:00 | 16.9 | 0.01 | 4.50 | 3.30 | 0.00 |
| 26/01/13 07:00 | 60.0 | 0.01 | 4.30 | 1.20 | 0.00 |
| 26/01/13 08:00 | 60.0 | 0.01 | 4.30 | 1.20 | 0.00 |
| 26/01/13 09:00 | 60.0 | 0.01 | 4.40 | 1.20 | 0.00 |
| 26/01/13 10:00 | 60.0 | 0.01 | 4.40 | 1.20 | 0.00 |
| 26/01/13 11:00 | 60.0 | 0.01 | 4.40 | 1.20 | 0.00 |
| 26/01/13 12:00 | 60.0 | 0.01 | 4.40 | 1.20 | 0.00 |
| 26/01/13 13:00 | 60.0 | 0.01 | 4.40 | 1.20 | 0.00 |
| 26/01/13 14:00 | 60.0 | 0.01 | 4.30 | 1.20 | 0.00 |
| 26/01/13 15:00 | 60.0 | 0.01 | 4.40 | 1.20 | 0.00 |
| 26/01/13 16:00 | 60.0 | 0.01 | 4.40 | 1.20 | 0.00 |
| 26/01/13 17:00 | 60.0 | 0.01 | 4.40 | 1.20 | 0.00 |
| 26/01/13 18:00 | 60.0 | 0.01 | 4.40 | 1.20 | 0.00 |
| 26/01/13 19:00 | 60.0 | 0.01 | 4.40 | 1.20 | 0.00 |
| 26/01/13 20:00 | 60.0 | 0.01 | 4.40 | 1.20 | 0.00 |
| 26/01/13 21:00 | 60.0 | 0.01 | 4.40 | 1.20 | 0.00 |
| 26/01/13 22:00 | 60.0 | 0.01 | 4.40 | 1.20 | 0.00 |
| 26/01/13 23:00 | 60.0 | 0.01 | 4.40 | 3.40 | 0.90 |
| 26/01/14 00:00 | 60.0 | 0.01 | 4.40 | 1.20 | 0.00 |
| 26/01/14 01:00 | 60.0 | 0.01 | 4.40 | 1.20 | 0.00 |
| 26/01/14 02:00 | 60.0 | 0.01 | 4.40 | 1.40 | 0.00 |

## 5. Top 대기 이벤트

**요약:**
- **총 대기 이벤트 수**: 110개
- **주요 대기 클래스**: System (326357695s), DB (172889676s), User (28952745s)
...
**요약:**
- **총 권장사항 수**: 15개
- **현재 SGA 크기**: 11648 MB (예상 DB Time: 1595, 예상 Physical Reads: 39565)
- **권장 SGA 크기**: 2912 MB (예상 DB Time: 1595, 예상 Physical Reads: 39565)
