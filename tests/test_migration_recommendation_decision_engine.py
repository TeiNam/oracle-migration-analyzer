...
# Property 3: Replatform 조건 일관성 (THRESHOLD_IMPROVEMENT_PROPOSAL.md 기반)
@given(
...
def test_replatform_condition_high_sql_complexity(
    ...
    평균 SQL 복잡도 >= 6.0, the system should recommend Replatform (기존 7.0에서 하향)

    Validates: Requirements 2.2, 2.3, 2.4, THRESHOLD_IMPROVEMENT_PROPOSAL.md
    """
...
def test_replatform_condition_high_plsql_complexity(
    ...
    Feature: migration-recommendation, Property 3: For any analysis result where
    평균 PL/SQL 복잡도 >= 6.0, the system should recommend Replatform (기존 7.0에서 하향)
...
@given(
    avg_sql_complexity=st.floats(
        min_value=0.0, max_value=5.9, allow_nan=False, allow_infinity=False
    ),
    avg_plsql_complexity=st.floats(
        min_value=0.0, max_value=5.9, allow_nan=False, allow_infinity=False
    ),
...
def test_replatform_condition_high_complexity_ratio(
    ...
    Feature: migration-recommendation, Property 3: For any analysis result where
    복잡 오브젝트 비율 >= 25%, the system should recommend Replatform (기존 30%에서 하향)
...
# Property 4: Aurora MySQL 조건 일관성 (THRESHOLD_IMPROVEMENT_PROPOSAL.md 기반)
@given(
    avg_sql_complexity=st.floats(
...
def test_aurora_mysql_condition_consistency(
    ...
    평균 SQL 복잡도 <= 4.0 and 평균 PL/SQL 복잡도 <= 3.5 and PL/SQL 오브젝트 < 20개,
    the system should recommend Aurora MySQL (기존 5.0/5.0/50개에서 하향)

    Validates: Requirements 3.1, 3.2, THRESHOLD_IMPROVEMENT_PROPOSAL.md
    """
    engine = MigrationDecisionEngine()
...
@given(
    avg_sql_complexity=st.floats(
        min_value=4.01, max_value=10.0, allow_nan=False, allow_infinity=False
    ),
    avg_plsql_complexity=st.floats(
        min_value=0.0, max_value=3.5, allow_nan=False, allow_infinity=False
    ),
...
def test_aurora_mysql_not_recommended_high_sql_complexity(
    ...
    Feature: migration-recommendation, Property 4: For any analysis result where
    평균 SQL 복잡도 > 4.0, the system should NOT recommend Aurora MySQL (기존 5.0에서 하향)
...
@given(
    ...
    avg_plsql_complexity=st.floats(
        min_value=3.51, max_value=10.0, allow_nan=False, allow_infinity=False
    ),
    total_plsql_count=st.integers(min_value=0, max_value=19),
    high_complexity_ratio=st.floats(
        min_value=0.0, max_value=0.24, allow_nan=False, allow_infinity=False
...
def test_aurora_mysql_not_recommended_high_plsql_complexity(
    ...
    Feature: migration-recommendation, Property 4: For any analysis result where
    평균 PL/SQL 복잡도 > 3.5, the system should NOT recommend Aurora MySQL (기존 5.0에서 하향)
...
def test_aurora_mysql_not_recommended_many_plsql_objects(
    ...
    Feature: migration-recommendation, Property 4: For any analysis result where
    PL/SQL 오브젝트 >= 20개, the system should NOT recommend Aurora MySQL (기존 50개에서 하향)
...
def test_aurora_postgresql_condition_many_bulk_operations(
    ...
    BULK 연산 >= 10개 and 복잡도 < 6.0, the system should recommend Aurora PostgreSQL

    Validates: Requirements 4.1, 4.2, 4.3, THRESHOLD_IMPROVEMENT_PROPOSAL.md
    """
    engine = MigrationDecisionEngine()
...
@given(
    avg_sql_complexity=st.floats(
        min_value=4.01, max_value=5.9, allow_nan=False, allow_infinity=False
    ),
    avg_plsql_complexity=st.floats(
        min_value=0.0, max_value=5.9, allow_nan=False, allow_infinity=False
    ),
...
def test_aurora_postgresql_condition_medium_sql_complexity(
    ...
    Feature: migration-recommendation, Property 5: For any analysis result where
    4.0 < 평균 SQL 복잡도 < 6.0, the system should recommend Aurora PostgreSQL
...
@given(
    ...
    avg_plsql_complexity=st.floats(
        min_value=3.51, max_value=5.9, allow_nan=False, allow_infinity=False
    ),
    high_complexity_ratio=st.floats(
        min_value=0.0, max_value=0.24, allow_nan=False, allow_infinity=False
    ),
...
def test_aurora_postgresql_condition_complex_plsql(
    ...
    Feature: migration-recommendation, Property 5: For any analysis result where
    3.5 < 평균 PL/SQL 복잡도 < 6.0, the system should recommend Aurora PostgreSQL
...
# Property 18: 의사결정 우선순위 (THRESHOLD_IMPROVEMENT_PROPOSAL.md 기반)
@given(
    avg_sql_complexity=st.floats(
        min_value=6.0, max_value=10.0, allow_nan=False, allow_infinity=False
    ),
...
def test_decision_priority_complexity_first(
    avg_sql_complexity, avg_plsql_complexity, bulk_operation_count, total_plsql_count
):
    """
    ...
    복잡도가 6.0 이상이면 다른 조건과 관계없이 Replatform을 추천해야 합니다. (기존 7.0에서 하향)

    Validates: Requirements 10.1, THRESHOLD_IMPROVEMENT_PROPOSAL.md
    """
    engine = MigrationDecisionEngine()
...
def test_decision_priority_high_complexity_ratio_first(
    ...
    복잡 오브젝트 비율이 25% 이상이면 다른 조건과 관계없이 Replatform을 추천해야 합니다. (기존 30%에서 하향)
